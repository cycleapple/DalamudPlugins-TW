...
| 插件 | 版本 | 說明 |
|------|------|------|
| **Penumbra** | 1.5.0.5 | Mod 載入器與管理工具（修正台服特徵碼並讀取 TC 繁中 Excel 頁） |
| **Simple Heels** | 0.10.7.4 | 穿著 Mod 高跟鞋時調整角色位置 |
| **Brio** | 0.5.2.0 | GPose 增強工具，用於拍照與動作控制 |
| **Glamourer** | 1.5.0.4 | 外觀修改與儲存工具（需要 Penumbra）- **已修正台服 TC 繁中 Excel 語言頁** |
| **Customize+** | 2.0.7.25 | 透過編輯骨骼參數自訂角色外觀 - **已修正台服 TC 繁中 Excel 語言頁** |
